...
from my_project.transactions import read_transactions_csv, read_transactions_excel

BASE_DIR = Path(os.path.dirname(os.path.dirname(__file__)))


def test_read_transactions_csv_returns_list_of_dicts() -> None:
    file_path = BASE_DIR / "data" / "transactions.csv"
...
def test_read_transactions_excel_returns_list_of_dicts() -> None:
    file_path = BASE_DIR / "data" / "transactions_excel.xlsx"
